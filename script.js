...
function display(data) {
    ...
    document.querySelector(".nationality").innerHTML = "Nationality: " + JSON.stringify(country);
    document.querySelector(".probability").innerHTML = "Probability: " + JSON.stringify(probability);
}
